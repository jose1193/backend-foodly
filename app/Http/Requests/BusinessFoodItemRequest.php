...
class BusinessFoodItemRequest extends FormRequest
{
    /**
...
{
    $isStoreRoute = $this->is('api/business-food-item/store');
    return [
        'business_food_category_id' => ($isStoreRoute ? 'required|' : '') . 'exists:business_food_categories,id',
